...
def train_and_evaluate(params, X_train_scaled, y_train, X_val_scaled, y_val):
    ...
    return n_estimators, max_depth, val_mse, train_mse, val_mse, train_r2, val_r2, train_rmse, val_rmse
...
def main():
    ...
    params_list = [(n_estimators, max_depth) for n_estimators in n_estimators_list for max_depth in max_depth_list]
    ...
    for params in params_list:
        ...
        for train_file, val_file in fold_files:
            try:
                ...
                n_estimators, max_depth, val_mse, train_mse, val_mse, train_r2, val_r2, train_rmse, val_rmse = train_and_evaluate(
