...
def main():
    ...
    try:
        ...
        print(f"Training set: accuracy={train_acc:.4f}, precision={train_precision:.4f}, recall={train_recall:.4f}, F1={train_f1:.4f}, AUC={train_auc:.4f}")
        print(f"test set: accuracy={test_acc:.4f}, precision={test_precision:.4f}, recall={test_recall:.4f}, F1={test_f1:.4f}, AUC={test_auc:.4f}")
        print("\n" + "="*50 + "\n")
